...
<!--USE THE SAME FORMAT FOR EVERYTHING JUST CHANGE FILTER NAME, a href link, img src link, and the details. Add pictures in /img -->
        <div class="row" id="portfolio-wrapper">
          ...
          ^^Edit filter-binghamton to filter-(city) with one of the cities listed in the code above this. 
            ...
            ^^ edit the link in "" to the link of the craigslist listing
              <img src="img/binghamton1.jpg" alt="">
              ^^ Put a picture of the listing in /img and change the file location accordingly. 
              <div class="details">
                <h4>12 bed Student House</h4>
                ^^Title of listing
                <span>$525/month/pp</span>
                ^^extra info
              </div>
            </a>
          </div>
